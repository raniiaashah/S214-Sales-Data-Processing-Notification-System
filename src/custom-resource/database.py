...
class DatabaseInitializer:
    ...
    def _get_credentials(self) -> Dict[str, str]:
        ...
        try:
            ...
            raise DatabaseInitializationError(f"Failed to retrieve credentials: {str(e)}")
    ...
    def connect(self) -> None:
        ...
        try:
            ...
            raise DatabaseInitializationError(f"Failed to connect to database: {str(e)}")
    ...
    def insert_sample_data(self) -> int:
        ...
        try:
            with self.connection.cursor() as cursor:
                ...
                if result['count'] > 0:
                    logger.info(f"Sample data already exists ({result['count']} records). Skipping insertion.")
                    return 0
                
                # Sample sales data
                sample_data = [
                    # Electronics
                    ('ORD-001', 'Wireless Headphones', 'Electronics', 2, 79.99, 159.98, '2024-01-15'),
                    ('ORD-002', 'Smartphone Case', 'Electronics', 3, 24.99, 74.97, '2024-01-15'),
                    ('ORD-003', 'USB-C Cable', 'Electronics', 5, 12.99, 64.95, '2024-01-15'),
                    ('ORD-004', 'Bluetooth Speaker', 'Electronics', 1, 49.99, 49.99, '2024-01-15'),
                    ('ORD-005', 'Wireless Headphones', 'Electronics', 1, 79.99, 79.99, '2024-01-15'),
                    
                    # Clothing
                    ('ORD-006', 'Cotton T-Shirt', 'Clothing', 4, 19.99, 79.96, '2024-01-15'),
                    ('ORD-007', 'Denim Jeans', 'Clothing', 2, 59.99, 119.98, '2024-01-15'),
                    ('ORD-008', 'Running Shoes', 'Clothing', 1, 89.99, 89.99, '2024-01-15'),
                    ('ORD-009', 'Winter Jacket', 'Clothing', 1, 129.99, 129.99, '2024-01-15'),
                    
                    # Home & Garden
                    ('ORD-010', 'Coffee Maker', 'Home & Garden', 1, 79.99, 79.99, '2024-01-15'),
                    ('ORD-011', 'Plant Pot Set', 'Home & Garden', 2, 29.99, 59.98, '2024-01-15'),
                    ('ORD-012', 'Kitchen Scale', 'Home & Garden', 1, 34.99, 34.99, '2024-01-15'),
                    
                    # Sports
                    ('ORD-013', 'Yoga Mat', 'Sports', 2, 29.99, 59.98, '2024-01-15'),
                    ('ORD-014', 'Dumbbells Set', 'Sports', 1, 49.99, 49.99, '2024-01-15'),
                    ('ORD-015', 'Resistance Bands', 'Sports', 3, 14.99, 44.97, '2024-01-15'),
                    
                    # Additional data for yesterday
                    ('ORD-016', 'Wireless Headphones', 'Electronics', 1, 79.99, 79.99, '2024-01-14'),
                    ('ORD-017', 'Cotton T-Shirt', 'Clothing', 2, 19.99, 39.98, '2024-01-14'),
                    ('ORD-018', 'Coffee Maker', 'Home & Garden', 1, 79.99, 79.99, '2024-01-14'),
                    ('ORD-019', 'Yoga Mat', 'Sports', 1, 29.99, 29.99, '2024-01-14'),
                    ('ORD-020', 'Smartphone Case', 'Electronics', 2, 24.99, 49.98, '2024-01-14'),
                ]
    ...
    def cleanup(self) -> None:
        ...
        try:
            ...
            logger.warning(f"Cleanup encountered an issue (table may not exist): {str(e)}")
        finally:
            self.disconnect()
